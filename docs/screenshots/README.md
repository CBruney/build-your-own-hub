...
![Desktop briefing with agenda, decisions, and content tiles](briefing-desktop.png)
...
![Personalization controls](personalize-desktop.png)
...
![Source status and observation times](connections-desktop.png)
...
![Family meeting decision cards](family-meeting-desktop.png)
...
![Sports detail with result hidden](spoiler-control-desktop.png)

![Opportunity Radar ideas and feedback controls](radar-desktop.png)

## Smaller screens

The tablet keeps the agenda and decisions together. The phone stacks the content and moves navigation to the bottom.

![Tablet briefing](briefing-tablet.png)
